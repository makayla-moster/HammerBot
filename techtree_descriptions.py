descriptions = {
    ...
    "Andean Sling": " Upgrades your skirmishers and slingers by removing their minimum range; Slingers receive +1 attack.",
    ...
    "Inquisition": " Increases monk conversion rate; Missionaries receive +1 range.",
    ...
    "Chieftains": " Infantry get attack bonus vs. cavalry and generate gold when killing villagers (5 gold), trade units (20 gold), and monks (20 gold).",
    "Greek Fire": " Fire Ships have +1 range; Bombard Towers receive +5 blast damage.",
    ...
    "Flemish Revolution": " Upgrades all existing Villagers to Flemish Militia and allows Flemish Militia to be created at the Town Center. The cost is increased by 10X food and 5X gold where X is the number of villagers you currently have.",
    "First Crusade": " Each Town Center (maximum 5) spawns a one-time batch of 5 Serjeants. Units more resistant to conversion.",
    ...
    "Stronghold": " Makes your castles and towers stronger by making them fire 33% faster; Castles heal allied infantry in a 7 tile radius.",
